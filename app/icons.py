...
_PATHS = {
    ...
    "upload-cloud": '<path d="M12 13v8"/><path d="M4 14.9A7 7 0 1 1 15.7 8h1.8a4.5 4.5 0 0 1 2.5 8.2"/><path d="m8 17 4-4 4 4"/>',
    ...
    "sparkles": '<path d="M9.94 14.34 12 20l2.06-5.66L20 12l-5.94-2.34L12 4l-2.06 5.66L4 12z"/>',
...
def icon(name: str, size: int = 20, stroke: float = 2, cls: str = "") -> str:
    ...
    return (
        ...
        f'style="display:inline-block;vertical-align:-.15em;flex:none">{body}</svg>'
    )
